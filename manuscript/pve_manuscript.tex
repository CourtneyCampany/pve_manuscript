...
Model M\textsubscript{0}, was able to converge on an optimum leaf mass fraction (21.6~\%) which accurately predicted the mean harvest total biomass of free seedlings within 1.2~\%. Using this leaf mass fraction to drive the interaction betwen leaf \textit{A} rates, via \textit{C}\textsubscript{day}, and seedling biomass production M\textsubscript{1}. When comparing against predicted total net leaf carbon gain modelled seedlings with soil volume restriction had 23$\pm$2.4~g carbon more than measured seedlings (Fig.~\ref{fig:figure6}a). Thus, When modelled and oberserved total carbon mass were compared with the mean reduction in daily assimilated carbon  mass carbon was overestimated by an average of 50$\pm$8.7~\% in seedlings with soil volume restriction (Fig.~\ref{fig:figure6}b). It is therefore apparent that the reductions in leaf \textit{A} were not sufficiently high enough to explain the reduction in harvested seedling biomass with soil volume restriction. This resulted in an unexplained pool of excess carbon, generated from \textit{A}, that did not end up in biomass. 

The remaining model simulations tested carbon allocation scenarios in an attempt to account for this remaining pool of missing carbon. Increases of 50~\% in non-leaf tissue respiration (M\textsubscript{3}) improved biomass estimates slightly but still overestimated mass carbon by an average of 46$\pm$9.3~\% in seedlings with soil volume restriction (Fig.~\ref{fig:figureSI1}b). It was further determined that in order to account for this pool of carbon the non-tissue respiration rates in modelled seedlings would have to have increased by 250~\%. Constraining the model with the measured treatment specific leaf mass fraction from the final harvest (M\textsubscript{2}) still overestimated seedling total carbon by 32$\pm$11.1~\%, but provided the most improved model predictions (Fig.~\ref{fig:figureSI1}a). Harvested leaf mass fraction, however, does not capture the likely increase in senescence of seedlings in small containers (Fig.~\ref{fig:figure2}c). Thus, the 7-61~\% reduction in measured harvested leaf mass fraction from large to small soil volumes compared to the optimized leaf mass fractions (M\textsubscript{0}) represents an underestimation of realized leaf carbon allocation.

\section*{Discussion}
As issues still remain regarding how source-sink coordination affects growth of woody species, this study utilized a simple but novel field design to first test how belowground sink limitation would physically restrict seedling production. We successfully created a belowground sink limitation on Eucalyptus seedlings and then addressed important questions regarding the coordination of photosynthesis and growth by complementing empirical results with modelling approaches. We found that reductions in leaf photosynthesis rates were not sufficient to explain observed reductions in total plant biomass production after 120 days. We thus encourage the utilization of mass balance approaches and provide direction for future studies when testing the factors that control of plant growth under environmental change.
...
\citep{mcconnaughay1991physical, young1997mechanical}
