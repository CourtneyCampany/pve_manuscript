...
Model M\textsubscript{0}, was able to converge on an optimum leaf mass fraction (21.6~\%) which accurately predicted the mean harvest total biomass of free seedlings within 1.2~\%. Using this leaf mass fraction to drive the interaction betwen leaf \textit{A} rates, via \textit{C}\textsubscript{day}, and seedling biomass production M\textsubscript{1}. When comparing against predicted total net leaf \textit{C} gain, the gross primary productvity of modelled seedlings with soil volume restriction were on average 23$\pm$2.4~g \textit{C} more than measured seedlings (Fig.~\ref{fig:figure6}a). Thus, seedling mass \textit{C} was overestimated by an average of 50$\pm$8.7~\% in modelled seedlings across the reductions in daily \textit{C} assimilation per treatment (Fig.~\ref{fig:figure6}b). It is therefore apparent that the reductions in leaf \textit{A} were not sufficiently high enough to explain the reduction in harvested seedling biomass with soil volume restriction. This resulted in an unexplained pool of excess \textit{C}, generated from \textit{A}, that did not end up in biomass. 

The remaining model simulations tested \textit{C} allocation scenarios in an attempt to account for this remaining pool of missing \textit{C} Increases of 50~\% in non-leaf tissue respiration (M\textsubscript{3}) improved biomass estimates slightly but still overestimated mass \textit{C} by an average of 46$\pm$9.3~\% in seedlings with soil volume restriction (Fig.~\ref{fig:figureSI1}b). It was further determined that in order to account for this pool of \textit{C} the non-tissue respiration rates in modelled seedlings would have to have increased by 250~\%. Constraining the model with the measured treatment specific leaf mass fraction from the final harvest (M\textsubscript{2}) still overestimated seedling total \textit{C} by 32$\pm$11.1~\%, but provided the most improved model predictions (Fig.~\ref{fig:figureSI1}a). Harvested leaf mass fraction, however, does not capture the likely increase in senescence of seedlings in small containers (Fig.~\ref{fig:figure2}c). Thus, the 7-61~\% reduction in measured harvested leaf mass fraction from large to small soil volumes compared to the optimized leaf mass fractions (M\textsubscript{0}) represents an underestimation of realized leaf \textit{C} allocation.

\section*{Discussion}
As issues still remain regarding how source-sink coordination affects growth of woody species, this study utilized a simple but novel field design to first test how belowground sink limitation would physically restrict seedling production. We successfully created a belowground sink limitation on Eucalyptus seedlings and then addressed important questions regarding the coordination of \textit{A} and growth by complementing empirical results with modelling approaches. We found that reductions in leaf \textit{A} rates were not sufficient to explain observed reductions in total plant biomass production after 120 days. We thus encourage the utilization of mass balance approaches and provide direction for future studies when testing the factors that control of plant growth under environmental change.

\subsection*{\textit{Can soil volume restriction reduce belowground sink strength and physically constrain growth?}}
As soon as seedlings became established both height and diameter growth were negatively affected as a function of available soil volume compared to free seedlings, providing immediate evidence in support of H1. These growth reductions were expected, as the impedance of root growth can cause reductions overall plant growth and activity \citep{mcconnaughay1991physical, young1997mechanical}. Is has been shown that roots undergoing difficult conditions may send inhibitory signals to the shoots that affect stomatal conductance, cell expansion, cell division and the rate of leaf appearance \citep{passioura2002soil}. This was strongly evident in the large divergence in leaf area between seedlings in containers and free seedlings through time and the eventual cessation of new leaf growth in seedlings in containers. As growth was so strongly affected as a functional of container size we then asked if mass partitioning strategies manifested through time to result in the observed differences in growth across soil volume manipulations and free seedlings.	As mass partitioning is likely controlled by source and sinks strength of all organs \citep{poorter2012biomass} it was important to determine which sinks were most affected in order to evaluate and then model this response accurately.

As differential mass allocation to leaves, stems or roots must occur at the expense of other structures \citep{mccarthy2007consistency} it was necessary to first distinguish if belowground sink limitation affected growth beyond ontogenetic constraints. In this study, there were no significant changes in root, leaf, or stem mass fractions to reduced soil volume compared to free seedlings, outside of ontogenetic drift. This is significant as shifts in allocation, beyond ontogeny, have been noted specifically for nutrient limitation compared to light, CO\textsubscript{2}, and water \citep[references therein]{mcconnaughay1999biomass}. Additionally, this provides evidence against the preservation of functional balance through optimal foraging, perhaps the most common explanation of changes in plant growth under some environmental stress. Under this scenario seedlings in this experiment would have been expected to preferentially allocate more biomass to fine roots to increase uptake of a finite soil resource pool. In this study the fine root mass to leaf mass ratio was conserved, regardless of plant size or treatment, suggesting an active mass partitioning strategy to optimize soil resource gain did not occur. 

Alternatively, physical restriction of root proliferation could have impacted root development or morphology prior to shifts in mass partitioning. For example, lateral root development is affected by inanimate obstacles and avoiding growth towards container walls could improve the efficiency of resource allocation \citep{falik2005root}. Also, the sensitivity of roots to their own exudates near obstructions may be used to adjust growth before stressful conditions occur \citep{semchenko2008foraging}. As a result, seedlings in small container sizes might alter fine root morphology, by increasing fine root length, to increase resource uptake potential.Plants in containers have been shown to have different root morphology to field grown plants as roots essentially compete with themselves for nutrients \citep{nesmith1998effect}, but data for woody species is still limited.
Here, neither specific root length nor partitioning between fine and coarse root mass fractions differed across treatments, providing further evidence against any functional plant response beyond developmental isometric growth.

\subsection*{\textit{Did the belowground sink limitation instead reduce photosynthesis, which reduced growth?}}

As a plant has to balance the allocation to leaves, stems and roots in a way that matches the physiological activities and functions performed by these organs \citep{poorter2012biomass}, the observed reductions in seedling growth could instead have resulted from \textit{C} source-sink imbalances. For example, the consequences of either stomatal closure or soil resource depletion to the sensitivity of these source-sink activities could lead to reductions in leaf photosynthesis, the central driver of plant \textit{C} gain and growth. Contrary to what was hypothesized, just as height reductions were immediately evident with new growth, so were photosynthesis rates on newly formed leaves. Initially, this suggests a tight link between reduced leaf carbon assimilation and seedling growth occurred in this study. It was therefore necessary to distinguish if source or sink limitation resulted in reduced light saturated photosynthesis rates and photosynthetic capacity throughout the experiment.

With high rates of stomatal conductance, non-limiting leaf water potential and consistent leaf {\textdelta}\textsuperscript{13}C across soil volume treatments there was little evidence of source limitation to \textit{A} in this study. This finding is consistent with other container size studies, with source manipulation via elevated CO\textsubscript{2}, where inhibition of CO\textsubscript{2} enrichment often results from sink limitation on photosynthetic capacity \citep{arp1991effects, robbins1988effect}. For example, reduced photosynthetic capacity in cotton seedlings grown at elevated CO\textsubscript{2} was associated with inadequate rooting volume and was attributed to sink-limited feedback inhibition, not decreased stomatal conductance \citep{thomas1991root}. Our results lend support to more general conclusions that neither growth \citep{korner2003carbon} nor photosynthesis \citep{millard2007environmental} of woody species is directly \textit{C} limited. Instead it was likely that reductions in photosynthesis occurred from the impact of a limited soil resource pool on belowground sink strength.

As both belowground space and resources were finite in containers, the limited ability of these seedlings to increase the capacity of the belowground \textit{C} sink was hypothesized to result in the buildup of assimilate in the leaves. This buildup, occurring via accumulation of leaf starch, was present as a function of decreasing container size throughout the study. As a result, photosynthetic capacity for all seedlings was highly correlated to leaf starch content across all measurement campaigns. The accumulation of leaf starch was accompanied by significant decreases \textit{J}\textsubscript{max} and \textit{Vc}\textsubscript{max}, both immediately evident during the first gas exchange campaign. Together this provides strong evidence that down regulation of \textit{A} likely occurred from reduced belowground \textit{C} sink strength in these seedlings. This down regulation was likely apparent throughout the entire experiment as leaf TNC content remained high in seedlings with soil volume restriction and the effects on \textit{J}\textsubscript{max} and \textit{Vc}\textsubscript{max} were again noted at the end of the experiment. 

As limited understanding between photosynthetic down regulation and source-sink regulation coordination still exists in woody species, the container size approach also allowed us to relate the induced belowground sink limitation with impacts to leaf physiology. Evidence for sink limitation of photosynthesis was evident in the stark contrast in leaf \textit{N} between free seedlings and seedlings in containers, combined with the strong correlation between leaf nitrogen and photosynthetic capacity. Leaf \textit{N} was also reduced compared to the free seedling controls when excess accumulation of leaf starch was present. Although the soil \textit{N} pool declined evenly across all treatments leaf \textit{N} was lowest in the smallest soil volume, suggesting that sink limitation was the greatest in these containers. This makes sense as small containers may reduce \textit{N} uptake, either from physical root restriction or decreased supply, and \textit{N} deficiencies can affect growth, Rubisco limitation, sugar metabolism, and carbohydrate partitioning between source and sink tissues (Stitt, 1991; Hermans et al., 2006). It could also have been possible for mycorrhizal colonization to be severely affected by the ‘container effect’. Whether unrestricted mycorrhizal recruitment facilitated the increase in leaf \textit{N} uptake to leaves in free seedlings is unknown. Regardless, the belowground sink strength of seedlings with soil volume treatments appears to have been greatly reduced and appears to be strongly linked with negative feedbacks to \textit{A}.

\subsection*{\textit{Does linkage between sink limitation and \textit{A} actually infer reduced seedling growth?}}
If the feedbacks between sink limitation and leaf \textit{A} controlled seedling growth then our growth model was expected to find agreement between simulated and observed seedling mass. A linkage between sink limitation and \textit{A}, however, does not necesarily imply the same level of coordination between reduced \textit{A} and growth with these seedlings. It was therefore necessary to test, using a mass balance approach, if the measured reductions in \textit{A} could be used to predict the patterns in seedling growth after 120~days. Constraining the initial model run (M\textsubscript{1}) by an optimized leaf mass fraction allowed us to test how well feedbacks from reduced \textit{A} rates could explain seedling growth. As a larger fraction of available carbon from \textit{A} rates ended up in modelled than measured seedlings, the initial model overestimated the biomass response to soil volume restriction. This finding lends strong evidence that \textit{A} and growth may not be entirely synced under environmental change, a very important distinction often missed in studies that manipulate source and sink activity. Thus, without more complete \textit{C} mass balance approach inferences to the nature of mechanisms controlling growth under environmental stress should only be speculative. The results from the initial seedling growth model, although informative, still left a large pool of missing \textit{C} that was unaccounted for with mass balance. As a result, we utilized the flexibility of the model to test potential sources of \textit{C} loss not explicitly measured, including changes to leaf \textit{C} allocation or non-leaf tissue respiration.  Through this approach, similar to \citep{lohier2014explaining}, we manipulated processes contributing to seedling \textit{C} mass balance and quantitatively tested their respective influences on model predictions. 

Altering the leaf mass fraction from that of the optimized free seedling control provided insight into how sink limitation may impact leaf \textit{C} allocation beyond that of \textit{A}. As this study was carried it in the field it was impossible to quantify impacts to leaf turnover that actually  occured, but  M\textsubscript{2} provides evidence for how the feedback between rates of photosyntheis and \textit{C} allocated to leaves can severely impact growth. Even as the treatment specific harvest leaf mass fraction was an overestimate it reveals how we should first understand the coupling between the \textit{C} allocated to leaves and \textit{A} when evaluating the corrdiation of \textit{A} and platn growth.  The decreasing leaf mass fraction with increasing soil volume restriction has several possible explanations.  First, TNC accumulation due to sink limitation can lead to accelerated leaf senescence \citep{paul2001sink}. Alternatively, as rates of \textit{A} were not different between soil volume treatments these seedlings could have reduced leaf production to maintain laws of stoichiometry (leaf \textit{C}:\textit{N} ratio) associated with reduced belowground \textit{C} sink strength and measured declines in leaf N. Thus, future empirical and modelling efforts should focus on the feedbacks from sink activity not only on leaf A rates but also on how this assimilate is allocated to leaves.  It is the interaction between these two components that will drive patterns of total canopy \textit{C} gain available for growth of the rest of the plant.

Increases in non-leaf respiration rates  M\textsubscript{3} improved biomass predictions but to a lesser extent than changes to leaf \textit{C} allocation.  This finding is still significant as it justifies the need for future studies to strengthen our knowledge of the effects of environmental change on respiration of multiple tissues components above and belowground. As \textit{C} balance is ultimately a delicate equilibrium between fluxes of photosynthesis and respiration, partial accounting of \textit{C} dynamics can easily lead to erroneous conclusions (Valentini et al. 2000). This expecially important with the increase in modelling studies to predict impacts of plant growth from environmental change. For example, there is lots of evidence of a close coupling between photosynthesis and respiration yet \textit{C} use efficiency is not constant \citep{cannell2000modelling}. How changes to sink activty may affect this coupling or regulcation of respiration rates acroos multiple tissues components will likely impact the syncronization of A and growth, yet our understanding of these affects acroos woody species is still poor. Thus, is most likely inapproporate to assume that respiration is an constant fraction of gross primary production in models \citep{delucia2007forest}.  The flexability of the modelling approach in this study can provide valuable insight into this issue in future works as it allows the ability to manipulate individual tissue respiration rates with either empirical, published or theortical data in order to achieve \textit{C} mass balance.  

\subsection*{\textit{conclusions}}
Although there is renewed debate about the interplay between photosynthesis and growth this topic has been addressed for a long time. It has long been know that conditions which affect the photosynthetic process affect growth but there is also an interrelationship between growth and photosynthesis \citep{sweet1966role}. Manipulations of plants grown in containers are often used to draw conclusions about growth and physiological principles but how these results actually reflect field-grown plants has seldom been studied. In this soil volume manipulation experiment, we found that the hierarchy of factors controlling plant growth goes beyond understanding just the feedback between photosynthesis and source-sink activity.  Combining a mass-balance approach with the use of a relatively simple plant production model revealed that a combination of different mechanisms must be at play in driving the seedling response to limiting soil volume. However, which of the mechanisms and the role they have in determining growth response will undoubtedly shift across different experimental manipulations and plant species. We argue that attempts to quantify or at least predict the fate of assimilated \textit{C} into known pools of growth, storage and \textit{C} loss are necessary before definitive answers of the question “Who controls plant growth?” are to be found. The widespread implications of this type of approach, which allows the flexibility to account for numerous potential drivers of plant growth and \textit{C} allocation, whether they are explicitly measured or not, can help answer questions about adaptive strategies and the fate of \textit{C} in plants undergoing environmental stress.

\citep{delucia2007forest}
