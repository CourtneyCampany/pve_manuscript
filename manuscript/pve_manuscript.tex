...
\begin{tabular}{lllllll}
  \hline
	{Volume~(L)} & $\mathrm{A_{max}~(\mu~mols~m^{-2}~s^{-1})}$ & $\mathrm{R_{dark}~(\mu~mols~m^{-2}~s^{-1})}$ & $\mathrm{J_{max}}$ & $\mathrm{Vc_{max}}$ & $\mathrm{g_s~(\mumols~m^{-2}~s^{-1})}$ & $\mathrm{g_1}$ \\ 
  \hline
